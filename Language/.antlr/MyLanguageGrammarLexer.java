...
public class MyLanguageGrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "MODULE", "IMPORT", "VARIABLES", "INT", "INT_V", 
			"REAL", "REAL_V", "STR", "STR_V", "ARRAY", "OF", "PROCEDURE", "IF", "THEN", 
			"ELSIF", "ELSE", "WHILE", "DO", "START", "END", "RETURN", "SEMI", "COMMA", 
			"LPAREN", "RPAREN", "EQ", "COLON", "PERIOD", "IDENT_V", "WS"
		};
	}
	...
	public MyLanguageGrammarLexer(CharStream input) {
		super(input);
